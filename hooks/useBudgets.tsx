...
export const useUpdateBudget = () => {
  return useCustomMutation({
    mutationFn: ({ year, month, category, amount }: BudgetProps) =>
      editBudget(amount, { year, month, category }),
...
export const useBudgetSummary = (selectedYearBudgets: BudgetProps[]) => {
  ...
  return useMemo(() => {
    ...
    for (const { month, category, amount } of selectedYearBudgets) {
      // 1-12 indexed months
