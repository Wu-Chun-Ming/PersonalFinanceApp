...
describe('useTransactions', () => {
  ...
  test('should fail to fetch transactions', async () => {
    (fetchTransactions as jest.Mock).mockRejectedValue(
      new Error('fetchTransactions error'),
    );
...
describe('useTransaction', () => {
  ...
  test('should fail to fetch transaction', async () => {
    (fetchTransaction as jest.Mock).mockRejectedValue(
      new Error('fetchTransaction error'),
    );
...
describe('useCreateTransaction', () => {
  ...
  test('should throw error when creating transaction', async () => {
    ...
    const mockShowToast = jest.fn();
    (useShowToast as jest.Mock).mockReturnValue(mockShowToast);
    (createTransactions as jest.Mock).mockRejectedValue(
      new Error('createTransactions error'),
    );
...
describe('useUpdateTransaction', () => {
  ...
  test('should throw error when editing transaction', async () => {
    ...
    const mockShowToast = jest.fn();
    (useShowToast as jest.Mock).mockReturnValue(mockShowToast);
    (editTransaction as jest.Mock).mockRejectedValue(
      new Error('editTransaction error'),
    );
...
describe('useDeleteTransaction', () => {
  ...
  test('should throw error when deleting transaction', async () => {
    ...
    const mockShowToast = jest.fn();
    (useShowToast as jest.Mock).mockReturnValue(mockShowToast);
    (deleteTransaction as jest.Mock).mockRejectedValue(
      new Error('deleteTransaction error'),
    );
